...
export const EmployeeDocumentManager = () => {
  ...
  const getCategoryBadge = (category) => {
    switch (category) {
      ...
      case 'marksheet':
        return (
          <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[11px] font-semibold bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 border border-blue-200 dark:border-blue-800">
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="space-y-1">
          ...
          <div className="relative">
            <select
              ...
              className="w-full flex h-10 rounded-xl border border-slate-200 dark:border-slate-800/80 bg-white dark:bg-[#12151E] px-3 py-2 text-sm text-slate-900 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-colors"
            >
        ...
        <div className="space-y-1 md:col-span-2">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-2 h-10 rounded-xl border border-slate-200 dark:border-slate-800/80 bg-white dark:bg-[#12151E] text-sm text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-colors"
            />
          </div>
        </div>
      </div>
            ...
            <button
              ...
              className={`flex items-center gap-2 px-3.5 py-1.5 rounded-xl text-xs font-medium whitespace-nowrap transition-all cursor-pointer ${
                isActive
                  ...
                  : 'bg-white dark:bg-[#12151E] border border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800/60'
              }`}
            >
      ...
      <Card className="p-0 overflow-hidden border border-slate-200/80 dark:border-slate-800/80">
        {loadingDocs ? (
                    ...
                    >
                      ...
                      <td className="px-5 py-3.5">
                        <div className="flex items-center gap-3">
                          <div className="p-2 rounded-xl bg-slate-100 dark:bg-slate-800/70 shrink-0 border border-slate-200 dark:border-slate-700/50">
                            {getFileIcon(docItem.fileType, docItem.fileName)}
                          </div>
                          <div className="min-w-0 max-w-xs">
                            <span className="font-semibold text-slate-900 dark:text-slate-100 block truncate" title={docItem.fileName}>
                              {docItem.fileName}
                            </span>
                            {docItem.description && (
                              <span className="text-xs text-slate-500 dark:text-slate-400 block truncate" title={docItem.description}>
                                {docItem.description}
                              </span>
                            )}
                          </div>
                        ...
                        <div className="flex items-center justify-end gap-2">
                          {docItem.downloadURL && (
                            <a
                              ...
                              className="inline-flex items-center gap-1 px-2.5 py-1.5 rounded-lg text-xs font-semibold bg-indigo-50 dark:bg-indigo-600/15 text-indigo-600 dark:text-indigo-400 hover:bg-indigo-100 dark:hover:bg-indigo-600/30 transition-colors"
