      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <Card className="p-4 flex items-center justify-between border-slate-200 dark:border-slate-800/80">
          <div>
            ...
            <p className="text-xl font-bold text-purple-600 dark:text-purple-400 mt-1">₹{avgCostPerLead.toLocaleString('en-IN')} / lead</p>
          </div>
            ...
            <form onSubmit={handleCreateCampaign} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-1.5 text-left">
                  ...
                  >
                    <option value="LinkedIn Ads" className="bg-white dark:bg-[#11141E] text-slate-900 dark:text-slate-100">LinkedIn Ads</option>
                    <option value="Google Search Ads" className="bg-white dark:bg-[#11141E] text-slate-900 dark:text-slate-100">Google Search Ads</option>
                    <option value="Organic Content & SEO" className="bg-white dark:bg-[#11141E] text-slate-900 dark:text-slate-100">Organic Content & SEO</option>
                    <option value="Email Newsletter" className="bg-white dark:bg-[#11141E] text-slate-900 dark:text-slate-100">Email Newsletter</option>
                    <option value="Event / Conference" className="bg-white dark:bg-[#11141E] text-slate-900 dark:text-slate-100">Event / Conference</option>
                  </select>
                </div>
