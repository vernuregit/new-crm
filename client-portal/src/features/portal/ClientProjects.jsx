...
export const ClientProjects = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        {projects.map((p) => (
          <Card key={p.projectId} hover className="space-y-4 border-slate-200 dark:border-slate-800">
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between text-xs text-slate-500 dark:text-slate-400">
                ...
                <span className="font-bold text-slate-800 dark:text-slate-200">{p.completionPercent}%</span>
              </div>
